...
//                                        <li><a href="publisherBrowse.jsp" title="<%=ResourceLoader.GetResource(session, "navbar.publishers.tooltip")">ResourceLoader.GetResource(session, "navbar.publishers")</a></li>
      ...
      out.write("\n");
      out.write("            <a href=\"javascript:ShowAssertionDialog();\" ><i class=\"icon-plus-sign icon-large\"></i>");
      out.print(ResourceLoader.GetResource(session, "items.publisherassertion.add"));
      out.write("</a><br><br>\n");
      out.write("            <div id=\"businesslist\">\n");
      out.write("                <img src=\"img/bigrollergreen.gif\" title=\"");
      out.print(ResourceLoader.GetResource(session, "items.loading"));
      out.write("\"/>\n");
      out.write("            </div>\n");
      out.write("\n");
      out.write("\n");
      out.write("            <script type=\"text/javascript\">\n");
      out.write("               \n");
      out.write("                function ShowAssertionDialog()\n");
      out.write("                {\n");
      out.write("                    $(\"#addPublisherAssertion\").modal('show');\n");
      out.write("                }\n");
      out.write("                function RenderAssertions()\n");
      out.write("                {\n");
      out.write("                    var lang = $(\"#lang\").text();\n");
      out.write("                    $(\"#businesslist\").html(\"<img src=\\\"img/bigrollergreen.gif\\\" title=\\\"Loading\\\"/>\");\n");
      out.write("                    var request=   $.ajax({\n");
      out.write("                        url: 'ajax/assertions.jsp',\n");
      out.write("                        type:\"GET\",\n");
      out.write("                        cache: false\n");
      out.write("                    });\n");
      out.write("                  \n");
      out.write("                    request.done(function(msg) {\n");
      out.write("                        window.console && console.log('postback done ');                \n");
      out.write("                        $(\"#businesslist\").html(msg);\n");
      out.write("                        //refresh();\n");
      out.write("                    });\n");
      out.write("\n");
      out.write("                    request.fail(function(jqXHR, textStatus) {\n");
      out.write("                        window.console && console.log('postback failed ');                                \n");
      out.write("                        $(\"#businesslist\").html(\"An error occured! \" + jqXHR.responseText + textStatus);\n");
      out.write("                        //refresh();\n");
      out.write("                    });\n");
      out.write("                }\n");
      ...
      out.write("                RenderAssertions();\n");
      out.write("\n");
      out.write("                function addAssertion()\n");
      out.write("                {\n");
      out.write("                    var ok=true;\n");
      out.write("                    var url='ajax/assertions.jsp';\n");
      out.write("                    var postbackdata = new Array();\n");
      out.write("                    $(\"div.edit\").each(function()\n");
      out.write("                    {\n");
      out.write("                        //TODO filter out (click to edit) values\n");
      out.write("                        var id=$(this).attr(\"id\");\n");
      out.write("                        var value=$(this).text();\n");
      out.write("                        if (value == i18n_clicktoedit)\n");
      out.write("                            ok = false;\n");
      out.write("                        postbackdata.push({\n");
      out.write("                            name: id, \n");
      ...
      out.write("                    }); \n");
      out.write("                    if (!ok)\n");
      out.write("                    {//TODO more internationalization\n");
      out.write("                        $(\"#saveresult\").html(\"A value must be specified for each value.\");\n");
      out.write("                        return;\n");
      out.write("                    }\n");
      out.write("    \n");
      out.write("                    var request=   $.ajax({\n");
      ...
      out.write("                        $(\"#saveresult\").html(msg);\n");
      out.write("                        RenderAssertions();\n");
      out.write("                    });\n");
      out.write("\n");
      out.write("                    request.fail(function(jqXHR, textStatus) {\n");
      out.write("                        window.console && console.log('postback failed ' + url);                                \n");
      out.write("                        $(\"#saveresult\").html(jqXHR.responseText + textStatus);\n");
      out.write("                    });\n");
      out.write("                }\n");
      out.write("              \n");
      out.write("                function approveAssertion(fromkey,tokey, tmodelkey, keyname, keyvalue)\n");
      out.write("                {\n");
      out.write("                    var ok=true;\n");
      out.write("                    var url='ajax/assertions.jsp';\n");
      out.write("                    var postbackdata = new Array();\n");
      out.write("                    postbackdata.push({\n");
      out.write("                        name: 'fromkey', \n");
      out.write("                        value: fromkey\n");
      out.write("                    });\n");
      out.write("                    postbackdata.push({\n");
      out.write("                        name: 'tokey', \n");
      out.write("                        value: tokey\n");
      out.write("                    });\n");
      out.write("                    postbackdata.push({\n");
      out.write("                        name: 'tmodelkey', \n");
      out.write("                        value: tmodelkey\n");
      out.write("                    });\n");
      out.write("                    postbackdata.push({\n");
      out.write("                        name: 'keyname', \n");
      out.write("                        value: keyname\n");
      out.write("                    });\n");
      out.write("                    postbackdata.push({\n");
      out.write("                        name: 'keyvalue', \n");
      out.write("                        value: keyvalue\n");
      out.write("                    });\n");
      out.write("                        \n");
      out.write("                    postbackdata.push({\n");
      out.write("                        name:\"nonce\", \n");
      ...
      out.write("                }\n");
      out.write("              \n");
      out.write("                function removeAssertion(fromkey,tokey, tmodelkey, keyname, keyvalue)\n");
      out.write("                {\n");
      out.write("                    var ok=true;\n");
      out.write("                    var url='ajax/assertions.jsp?action=delete';\n");
      out.write("                    var postbackdata = new Array();\n");
      out.write("                    postbackdata.push({\n");
      out.write("                        name: 'fromkey', \n");
      out.write("                        value: fromkey\n");
      ...
      out.write("    </div>\n");
      out.write("\n");
      out.write("    <div class=\"modal hide fade\" id=\"addPublisherAssertion\">\n");
      out.write("        <div class=\"modal-header\">\n");
      out.write("            <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">&times;</button>\n");
      out.write("            <h3>");
      out.print(ResourceLoader.GetResource(session, "items.publisherassertion.add"));
      out.write("</h3>\n");
      out.write("        </div>\n");
      out.write("        <div class=\"modal-body\" id=\"addPublisherAssertionContent\">\n");
      out.write("            ");
      out.print(ResourceLoader.GetResource(session, "items.publisherassertion.add.description"));
      out.write("<br>\n");
      out.write("            <div style=\"float:left;width:25%\">\n");
      out.write("                ");
      out.print(ResourceLoader.GetResource(session, "items.publisherassertion.add.fromkey"));
      out.write(" : </div><div id=\"fromkey\" class=\"edit\">");
      ...
      out.write("</div>\n");
      out.write("            <div style=\"float:left;width:25%\">");
      out.print(ResourceLoader.GetResource(session, "items.publisherassertion.add.tokey"));
      out.write(" : </div><div id=\"tokey\" class=\"edit\"></div>\n");
      out.write("            <div style=\"float:left;width:25%\">");
      out.print(ResourceLoader.GetResource(session, "items.tmodel.key"));
      out.write(" : </div><div id=\"tmodelkey\" class=\"edit\">uddi:uddi.org:relationships</div>\n");
      out.write("            <div style=\"float:left;width:25%\">");
      out.print(ResourceLoader.GetResource(session, "items.publisherassertion.add.keyname"));
      out.write(" : </div><div id=\"keyname\" class=\"edit\">Subsidiary</div>\n");
      out.write("            <div style=\"float:left;width:25%\">");
      out.print(ResourceLoader.GetResource(session, "items.publisherassertion.add.keyvalue"));
      out.write(" : </div><div id=\"keyvalue\" class=\"edit\">parent-child</div>\n");
      out.write("            <div id=\"saveresult\" style=\"color:red\"></div>\n");
      out.write("        </div>\n");
      out.write("        <script type=\"text/javascript\">\n");
      out.write("            Reedit();\n");
      out.write("        </script>\n");
      out.write("        <div class=\"modal-footer\">\n");
      out.write("            <a href=\"javascript:addAssertion();\" class=\"btn btn-primary\">");
      out.print(ResourceLoader.GetResource(session, "actions.save"));
      out.write("</a>\n");
      out.write("            <a href=\"javascript:$('#addPublisherAssertion').modal('hide');\" class=\"btn\">");
      out.print(ResourceLoader.GetResource(session, "modal.close"));
      out.write("</a>\n");
      out.write("        </div>\n");
      out.write("    </div>\n");
