...
public final class businessBrowse_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
...
//                                        <li><a href="publisherBrowse.jsp" title="<%=ResourceLoader.GetResource(session, "navbar.publishers.tooltip")">ResourceLoader.GetResource(session, "navbar.publishers")</a></li>
      ...
      out.write("</td><td><input type=\"text\" id=\"name_business\" value=\"%\" tabindex=\"1\"></td></tr>\n");
      out.write("                     <tr><td>");
      out.print(ResourceLoader.GetResource(session, "items.lang"));
      out.write("</td><td><input type=\"text\" id=\"lang_business\" tabindex=\"2\"></td></tr>\n");
      out.write("                  </table>\n");
      out.write("               </td>\n");
      out.write("            </tr>\n");
      out.write("         </table>\n");
      out.write("         <a href=\"javascript:pagedownBusiness();\"><i class=\"icon-circle-arrow-left disabled icon-2x\" id=\"pageupBusiness\"></i></a>\n");
      out.write("         <a href=\"javascript:refreshBusinessList();\"><i class=\"icon-refresh icon-2x\" id=\"refresh\"></i></a>\n");
      out.write("         <a href=\"javascript:pageupBusiness();\"><i class=\"icon-circle-arrow-right disabled icon-2x\" id=\"pagedownBusiness\"></i></a>\n");
      out.write("\n");
      ...
      out.write("            $(\"name_business\").keydown(function(e) {\n");
      out.write("               \n");
      out.write("               var newnow = + new Date();\n");
      out.write("               window.console && console.log(newnow + \" \" + now + \" refreshing business list (search as you type)\");\n");
      out.write("               if (newnow-now > 500 )\n");
      out.write("               {\n");
