...
public final class importFromWadl_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
...
//                                        <li><a href="publisherBrowse.jsp" title="<%=ResourceLoader.GetResource(session, "navbar.publishers.tooltip")">ResourceLoader.GetResource(session, "navbar.publishers")</a></li>
      ...
      out.write("                        ");
      out.print(ResourceLoader.GetResource(session, "pages.serviceimport.content.wadl"));
      out.write("<Br>\n");
      out.write("                        <br>\n");
      out.write("\n");
      ...
      out.write("                                                        ");
      out.print(ResourceLoader.GetResource(session, "pages.serviceimport.content.step1.wadl"));
      out.write("</a>\n");
      out.write("                                        </div>\n");
      out.write("                                        <div id=\"collapse1\" class=\"accordion-body collapse in\">\n");
      out.write("                                                <div class=\"accordion-inner\">\n");
      out.write("                                                        ");
      out.print(ResourceLoader.GetResource(session, "pages.serviceimport.content.step1a.wadl"));
      out.write("<br>\n");
      out.write("                                                        <input type=\"text\" id=\"wsdlurl\" placeholder=\"http://localhost:8080/services/myService?wadl\" style=\"width:100%\" ><br>\n");
      out.write("                                                        ");
      ...
      out.write("                                                        var trigger1_triggered = true;\n");
      out.write("                                                }\n");
      out.write("                                        }\n");
      out.write("\n");
      ...
      out.write("                                                var postbackdata = new Array();\n");
      out.write("                                                var url = 'ajax/importFromWadl.jsp';\n");
      out.write("                                                postbackdata.push({\n");
      out.write("                                                        name: \"nonce\",\n");
      out.write("                                                        value: $(\"#nonce\").val()\n");
      out.write("                                                });\n");
      ...
      out.write("                                                        <a class=\"btn btn-info\" onclick=\"save(true);\"><i class=\"icon-eye-open icon-large\"></i> ");
      out.print(ResourceLoader.GetResource(session, "actions.preview"));
      out.write("</a>\n");
      out.write("                                                        <a class=\"btn btn-primary\" onclick=\"save(false);\"><i class=\"icon-save icon-large\"></i>  ");
