...
public final class reginfo_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
...
//                                        <li><a href="publisherBrowse.jsp" title="<%=ResourceLoader.GetResource(session, "navbar.publishers.tooltip")">ResourceLoader.GetResource(session, "navbar.publishers")</a></li>
      ...
      out.write("            ");
      out.print(ResourceLoader.GetResource(session, "navbar.create.mybiz.content"));
      out.write("<br><Br>\n");
      out.write("            ");
      ...
      out.write("                    <button class=\"btn\">Actions</button>\n");
      ...
      out.write("                        <li>\n");
      out.write("                            <a class=\"btn btn-danger \" href=\"javascript:deleteBusinessByID('");
      out.print(URLEncoder.encode(info.getBusinessInfos().getBusinessInfo().get(i).getBusinessKey(), "UTF-8"));
      out.write("');\">");
      out.print(ResourceLoader.GetResource(session, "actions.delete"));
      out.write("</a></li>\n");
      out.write("                        <li><a class=\"btn btn-success \" href=\"signer.jsp?id=");
      out.print(URLEncoder.encode(info.getBusinessInfos().getBusinessInfo().get(i).getBusinessKey(), "UTF-8"));
      out.write("&type=business\">");
      out.print(ResourceLoader.GetResource(session, "actions.sign"));
      out.write("</a></li>\n");
      out.write("                        <li><a class=\"btn btn-info \" href=\"#\" title=\"");
      ...
      out.write("</a></li>\n");
      out.write("                        <li><a class=\"btn btn-warning \" href=\"#\" title=\"");
      ...
      out.write("</a></li>\n");
      out.write("                        <li><a class=\"btn \"  href=\"javascript:ViewAsXML('");
      out.print(StringEscapeUtils.escapeJavaScript(info.getBusinessInfos().getBusinessInfo().get(i).getBusinessKey()));
      out.write("');\">");
      ...
      out.write("</div>\n");
      out.write("\n");
      out.write("        <div class=\"modal hide fade\" id=\"viewAsXml\">\n");
      out.write("            <div class=\"modal-header\">\n");
      out.write("                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">&times;</button>\n");
      out.write("                <h3>");
      out.print(ResourceLoader.GetResource(session, "actions.asxml"));
      ...
      out.write("            </div>\n");
      out.write("            <div class=\"modal-footer\">\n");
      out.write("                <a href=\"javascript:$('#viewAsXml').modal('hide');\" class=\"btn\">");
      out.print(ResourceLoader.GetResource(session, "modal.close"));
      out.write("</a>\n");
      out.write("            </div>\n");
      out.write("        </div>\n");
      ...
      out.write("    \n");
      out.write("        \n");
      out.write("        function ViewAsXML(bizid)\n");
      out.write("        {\n");
      out.write("            $.get(\"ajax/toXML.jsp?id=\" + bizid + \"&type=business\", function(data){\n");
      out.write("                window.console && console.log('asXml success');                \n");
      out.write("                  \n");
      out.write("                $(\"#viewAsXmlContent\").html(\n");
      out.write("                \"<a href=\\\"ajax/toXML.jsp?id=\" + bizid + \"&type=business\\\" class=\\\"btn btn-primary\\\">Popout</a>  \" \n");
      out.write("                    +safe_tags_replace(data) + \"<br>\" \n");
      out.write("            );\n");
