...
public final class serviceBrowse_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
...
//                                        <li><a href="publisherBrowse.jsp" title="<%=ResourceLoader.GetResource(session, "navbar.publishers.tooltip")">ResourceLoader.GetResource(session, "navbar.publishers")</a></li>
      ...
      out.write("</td><td><input type=\"text\" id=\"name_service_search\" value=\"%\"></td></tr>\n");
      out.write("                        <tr><td>");
      out.print(ResourceLoader.GetResource(session, "items.lang"));
      out.write("</td><td><input type=\"text\" id=\"lang_service_search\" value=\"\"></td></tr>\n");
      out.write("                     </table>\n");
      out.write("                  </td>\n");
      out.write("               </tr>\n");
      out.write("            </table>\n");
      out.write("\n");
      out.write("            <a href=\"javascript:pagedownService();\"><i class=\"icon-circle-arrow-left icon-2x\" id=\"pageupService\"></i></a>\n");
      out.write("            <a href=\"javascript:refreshServiceList();\"><i class=\"icon-refresh icon-2x\" id=\"refresh\"></i></a>\n");
      out.write("            <a href=\"javascript:pageupService();\"><i class=\"icon-circle-arrow-right  icon-2x\" id=\"pagedownService\"></i></a>\n");
      out.write("\n");
      out.write("            <div id=\"serviceBrowserListings\">\n");
      out.write("               <img src=\"img/bigrollergreen.gif\" title=\"Loading\"/>\n");
      out.write("            </div>\n");
      out.write("            <script src=\"js/serviceBrowse.js\"></script>\n");
      out.write("            <script type=\"text/javascript\">\n");
      out.write("\n");
      out.write("               $('.edit').editable(function(value, settings) {\n");
      out.write("                 window.console && console.log(value + this + settings);\n");
      out.write("                  RenderServiceListBySearch('%', offset, maxrecords);\n");
