...
public final class viewSubscriptions_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
...
//                                        <li><a href="publisherBrowse.jsp" title="<%=ResourceLoader.GetResource(session, "navbar.publishers.tooltip")">ResourceLoader.GetResource(session, "navbar.publishers")</a></li>
      ...
      out.write("            <p>\n");
      out.write("                ");
      out.print(ResourceLoader.GetResource(session, "pages.viewsubscriptions.content"));
      out.write("</p>\n");
      out.write("            <a href=\"editSubscription.jsp\"><i class=\"icon-large icon-plus-sign\"></i> ");
      out.print(ResourceLoader.GetResource(session, "navbar.subscriptions.create"));
      out.write("</a><br><br>\n");
      out.write("            ");
      ...
      out.write("</th>\n");
      out.write("                    <th>");
      out.print(ResourceLoader.GetResource(session, "items.expires"));
      out.write("</th>\n");
      out.write("                    <th>");
      out.print(ResourceLoader.GetResource(session, "items.deliverymech"));
      out.write("</th>\n");
      out.write("                    <th>");
      out.print(ResourceLoader.GetResource(session, "items.actions"));
      out.write("</th>\n");
      out.write("                    <th>");
      out.print(ResourceLoader.GetResource(session, "items.maxitems"));
      out.write("</th>\n");
      out.write("                    <th>");
      ...
      out.write("<script type=\"text/javascript\">\n");
      out.write("                function deleteSub(key)\n");
      out.write("                {\n");
      out.write("                    var postbackdata = new Array();\n");
      out.write("                    var url = 'ajax/subscription.jsp';\n");
      out.write("\n");
      out.write("\n");
      out.write("                    postbackdata.push({\n");
      out.write("                        name: \"nonce\",\n");
      ...
      out.write("    <script type=\"text/javascript\">\n");
      out.write("\n");
      out.write("        function ViewAsXML(id)\n");
      out.write("        {\n");
      out.write("            $.get(\"ajax/toXML.jsp?id=\" + id + \"&type=subscription\", function(data) {\n");
