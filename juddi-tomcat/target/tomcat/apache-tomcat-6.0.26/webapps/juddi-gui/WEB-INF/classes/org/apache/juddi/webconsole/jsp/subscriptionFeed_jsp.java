...
public final class subscriptionFeed_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
...
//                                        <li><a href="publisherBrowse.jsp" title="<%=ResourceLoader.GetResource(session, "navbar.publishers.tooltip")">ResourceLoader.GetResource(session, "navbar.publishers")</a></li>
      ...
      out.write("            <p>");
      out.print(ResourceLoader.GetResource(session, "navbar.subscriptions.feed.content"));
      out.write(".</p>\n");
      out.write("            <div id=\"feedcontent\"></div>\n");
      out.write("            <script type=\"text/javascript\">\n");
      out.write("                $(\"#feedcontent\").html(\"<img src=\\\"img/bigrollergreen.gif\\\" title=\\\"Loading\\\"/>\");\n");
      out.write("                var request=   $.ajax({\n");
      out.write("                    url: 'ajax/subscriptionFeed.jsp',\n");
      out.write("                    type:\"GET\",\n");
      out.write("                    cache: false\n");
      out.write("                });\n");
      out.write("                  \n");
      ...
      out.write("                    $(\"#feedcontent\").html(msg);\n");
      out.write("                    //refresh();\n");
      out.write("                });\n");
      out.write("\n");
      out.write("                request.fail(function(jqXHR, textStatus) {\n");
      out.write("                    window.console && console.log('postback failed ');                                \n");
      out.write("                    $(\"#feedcontent\").html(\"An error occured! \" + textStatus + jqXHR);\n");
      out.write("                    //refresh();\n");
      out.write("                });\n");
      out.write("            </script>\n");
      out.write("        </div>\n");
