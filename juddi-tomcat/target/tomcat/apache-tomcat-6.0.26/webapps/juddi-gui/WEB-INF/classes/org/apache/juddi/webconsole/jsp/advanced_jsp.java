...
public final class advanced_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
...
//                                        <li><a href="publisherBrowse.jsp" title="<%=ResourceLoader.GetResource(session, "navbar.publishers.tooltip")">ResourceLoader.GetResource(session, "navbar.publishers")</a></li>
      ...
      out.write("            ");
      out.print( ResourceLoader.GetResource(session, "pages.advanced.content"));
      out.write("<br>\n");
      out.write("            <div class=\"btn-group\" data-toggle=\"buttons-radio\" id=\"serviceselection\">\n");
      out.write("                <button type=\"button\" value=\"inquiry\" onclick=\"javascript:toggleParent('inquiryparent');\" class=\"btn btn-primary\">Inquiry</button>\n");
      out.write("                <button type=\"button\" value=\"publish\"  onclick=\"javascript:toggleParent('publishparent');\" class=\"btn btn-primary\">Publish</button>\n");
      out.write("                <button type=\"button\" value=\"custody\"  onclick=\"javascript:toggleParent('custodyparent');\" class=\"btn btn-primary\">Custody Transfer</button>\n");
      out.write("                <button type=\"button\" value=\"subscription\"  onclick=\"javascript:toggleParent('subscriptionparent');\" class=\"btn btn-primary\">Subscriptions</button>\n");
      out.write("            </div>\n");
      out.write("            <div id=\"inquiryparent\">\n");
      out.write("                <select id=\"inquiry\" onchange=\"toggledivs('inquiry');\">\n");
      out.write("                    <option>findBinding</option>\n");
      out.write("                    <option>findBusiness</option>\n");
      out.write("                    <option>findService</option>\n");
      out.write("                    <option>findRelatedBusiness</option>\n");
      out.write("                    <option>findTModel</option>\n");
      out.write("                    <option>getBindingDetail</option>\n");
      out.write("                    <option>getBusinessDetail</option>\n");
      out.write("                    <option>getServiceDetail</option>\n");
      out.write("                    <option>getOperationalInfo</option>\n");
      out.write("                    <option>getTModelDetail</option>\n");
      out.write("                </select>\n");
      out.write("            </div>\n");
      out.write("\n");
      out.write("            <div id=\"publishparent\">\n");
      out.write("                <select id=\"publish\" onchange=\"toggledivs('publish');\">\n");
      out.write("                    <option>addPublisherAssertions</option>\n");
      out.write("                    <option>deleteBinding</option>\n");
      out.write("                    <option>deleteBusiness</option>\n");
      out.write("                    <option>deletePublisherAssertions</option>\n");
      out.write("                    <option>deleteService</option>\n");
      out.write("                    <option>deleteTModel</option>\n");
      out.write("                    <option>getAssertionStatusReport</option>\n");
      out.write("                    <option>getPublisherAssertions</option>\n");
      out.write("                    <option>getRegisteredInfo</option>\n");
      out.write("                    <option>saveBinding</option>\n");
      out.write("                    <option>saveBusiness</option>\n");
      out.write("                    <option>saveService</option>\n");
      out.write("                    <option>saveTModel</option>\n");
      out.write("                    <option>setPublisherAssertions</option>\n");
      out.write("                </select>\n");
      out.write("            </div>\n");
      out.write("            <div id=\"custodyparent\">\n");
      out.write("                <select id=\"custody\" onchange=\"toggledivs('custody');\">\n");
      out.write("                    <option>discardTransferToken</option>\n");
      out.write("                    <option>getTransferToken</option>\n");
      out.write("                    <option>transferEntities</option>\n");
      out.write("                </select>\n");
      out.write("            </div>\n");
      out.write("            <div id=\"subscriptionparent\">\n");
      out.write("                <select id=\"subscription\" onchange=\"toggledivs('subscription');\">\n");
      out.write("                    <option>deleteSubscription</option>\n");
      out.write("                    <option>getSubscriptionResults</option>\n");
      out.write("                    <option>getSubscriptions</option>\n");
      out.write("                    <option>saveSubscription</option>\n");
      out.write("                </select>\n");
      out.write("            </div>\n");
      out.write("\n");
      out.write("            <script type=\"text/javascript\">\n");
      out.write("                    function toggleParent(select) {\n");
      out.write("\n");
      out.write("                        $(\"#custodyparent\").hide();\n");
      out.write("                        $(\"#publishparent\").hide();\n");
      out.write("                        $(\"#subscriptionparent\").hide();\n");
      out.write("                        $(\"#inquiryparent\").hide();\n");
      out.write("                        $(\"#\" + select).show();\n");
      out.write("                    }\n");
      out.write("                    toggleParent('inquriyparent');\n");
      out.write("                    function toggledivs(select)\n");
      out.write("                    {\n");
      ...
      out.write("\n");
      out.write("                        postbackdata.push({\n");
      out.write("                            name: \"service\",\n");
      out.write("                            value: select\n");
      out.write("                        });\n");
      out.write("\n");
      out.write("                        postbackdata.push({\n");
      ...
      out.write("                            //trim it\n");
      out.write("                            $(\"#xmlcontent\").html(msg.replace(/^\\s+|\\s+$/g, ''));\n");
      out.write("                        });\n");
      out.write("\n");
      out.write("                        request.fail(function(jqXHR, textStatus) {\n");
      ...
      out.write("\n");
      out.write("                    function sendformdata() {\n");
      out.write("                        $(\"#senddataresults\").html(\"<img src=\\\"img/bigrollergreen.gif\\\" title=\\\"Loading\\\"/>\");\n");
      out.write("                        var select = $(\"#serviceselection > button.btn.active\").val();\n");
      out.write("                        var x = $(\"#\" + select).val();\n");
      out.write("                        var url = 'ajax/advanced.jsp';\n");
      out.write("\n");
      out.write("                        var postbackdata = new Array();\n");
      ...
      out.write("                            value: $(\"#xmlcontent\").val()\n");
      out.write("                        });\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write("                            window.console && console.log('postback done ' + url);\n");
      out.write("                            //trim it\n");
      out.write("                            $(\"#senddataresults\").html(msg.replace(/^\\s+|\\s+$/g, ''));\n");
      out.write("                        });\n");
      out.write("\n");
      out.write("                        request.fail(function(jqXHR, textStatus) {\n");
      out.write("                            window.console && console.log('postback failed ' + url);\n");
      out.write("                            $(\"#senddataresults\").html(jqXHR.responseText + textStatus);\n");
      out.write("                        });\n");
      out.write("                    }\n");
      out.write("            </script>\n");
      out.write("            <br>\n");
      out.write("            <textarea id=\"xmlcontent\" rows=\"8\" cols=\"120\"></textarea><br>\n");
      out.write("\n");
      out.write("            <a href=\"javascript:sendformdata();\" class=\"btn brn-primary\">");
      out.print( ResourceLoader.GetResource(session, "actions.submit"));
      out.write("</a>\n");
      out.write("            <br><br>\n");
      out.write("            <div id=\"senddataresults\"></div>\n");
      out.write("        </div>\n");
      out.write("    </div>\n");
      out.write("\n");
      out.write("    ");
