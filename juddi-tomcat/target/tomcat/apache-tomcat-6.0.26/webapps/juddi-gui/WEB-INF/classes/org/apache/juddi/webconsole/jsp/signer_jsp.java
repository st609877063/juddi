...
public final class signer_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
...
//                                        <li><a href="publisherBrowse.jsp" title="<%=ResourceLoader.GetResource(session, "navbar.publishers.tooltip")">ResourceLoader.GetResource(session, "navbar.publishers")</a></li>
      ...
      out.write("            ");
      out.print(ResourceLoader.GetResource(session, "items.dsigs.description"));
      out.write("<br>\n");
      out.write("            ");
      ...
      out.write("\n");
      out.write("\n");
      out.write("            You're about to digitally sign the <b>");
      out.print(StringEscapeUtils.escapeHtml(itemtype));
      out.write("</b> identified by the key <b>");
      out.print(StringEscapeUtils.escapeHtml(id));
      out.write("</b>.<br>\n");
      out.write("            By electronically signing this UDDI entry, other users will then be able to verify that this entry hasn't been modified.<br>\n");
      out.write("\n");
      out.write("            <applet code=\"org.apache.juddi.gui.dsig.XmlSigApplet2\" archive=\"applets/juddi-gui-dsig-all.jar\" MAYSCRIPT height=\"350px\" width=\"400px\"></applet> \n");
      out.write("            <script type=\"text/javascript\">\n");
      ...
      out.write("                });\n");
      out.write("                /**\n");
      out.write("                 * Called by the applet to obtaining the xml to be signed\n");
      out.write("                 */\n");
      out.write("                function getXml()\n");
      out.write("                {\n");
      out.write("                    return $(\"#data\").val();\n");
      out.write("                }\n");
      out.write("                    \n");
      out.write("                function go()\n");
      out.write("                {\n");
      out.write("                        \n");
      out.write("                    var form = $(\"#uddiform\");\n");
      out.write("                    var d = form.serializeArray();\n");
      out.write("                    var request=   $.ajax({\n");
      out.write("                        url: 'ajax/saveFromXML.jsp?id=");
      out.print(id);
      out.write("&type=");
      out.print(itemtype);
      out.write("',\n");
      ...
      out.write("                        //TODO timer to auto redirect to the\n");
      ...
      out.write("\t\t\t\t \n");
      out.write("                    /**\n");
      out.write("                     * called by the applet to refresh the page with the signed data\n");
      out.write("                     */\t \n");
      out.write("                    function writeXml(data)\n");
      out.write("                    {\n");
      out.write("                        $(\"#data\").val(data);\n");
      out.write("                        //post back to the publishing thread\n");
      out.write("                        var url='ajax/saveFromXML.jsp?id=");
      out.print(id);
      out.write("&type=");
      out.print(itemtype);
      out.write("'\n");
      ...
      out.write("                    {\n");
      out.write("                        return navigator.appName;\n");
      out.write("                    }\n");
      out.write("                    function getOsName()\n");
      out.write("                    {\n");
      out.write("                        var OSName=\"unknown OS\";\n");
      out.write("                        if (navigator.appVersion.indexOf(\"Win\")!=-1) OSName=\"Windows\";\n");
      out.write("                        if (navigator.appVersion.indexOf(\"Mac\")!=-1) OSName=\"MacOS\";\n");
      out.write("                        if (navigator.appVersion.indexOf(\"X11\")!=-1) OSName=\"UNIX\";\n");
      out.write("                        if (navigator.appVersion.indexOf(\"Linux\")!=-1) OSName=\"Linux\";\n");
      out.write("                        return OSName;\n");
      out.write("                    }\n");
      out.write("                    function getObjectType()\n");
      out.write("                    {\n");
      out.write("                        return \"");
      out.print(StringEscapeUtils.escapeJavaScript(itemtype));
      out.write("\";\n");
      out.write("                    }\n");
      out.write("                    //\n");
      out.write("                    //display:none  <a class=\"btn\" href=\"javascript:go();\">Go</a>\n");
      out.write("            </script>\n");
      out.write("\n");
      out.write("            <textarea class=\"hide\" name=\"data\" rows=\"15\" cols=\"80\" id=\"data\" style=\"\">");
