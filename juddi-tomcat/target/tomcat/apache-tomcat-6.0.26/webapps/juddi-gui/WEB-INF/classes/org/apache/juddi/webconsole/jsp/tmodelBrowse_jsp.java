...
public final class tmodelBrowse_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
...
//                                        <li><a href="publisherBrowse.jsp" title="<%=ResourceLoader.GetResource(session, "navbar.publishers.tooltip")">ResourceLoader.GetResource(session, "navbar.publishers")</a></li>
      ...
      out.write("      <h2>");
      out.print(ResourceLoader.GetResource(session, "items.tmodel.browser"));
      out.write("</h2>\n");
      out.write("   </div>\n");
      out.write("\n");
      ...
      out.write("\n");
      out.write("         </table>\n");
      out.write("         <a href=\"javascript:pagedown();\"><i class=\"icon-circle-arrow-left icon-2x\" id=\"pageup\"></i></a>\n");
      out.write("         <a href=\"javascript:reload();\"><i class=\"icon-refresh icon-2x\"></i></a>\n");
      out.write("         <a href=\"javascript:pageup();\"><i class=\"icon-circle-arrow-right icon-2x\" id=\"pagedown\"></i></a>\n");
      out.write("\n");
      ...
      out.write("            {\n");
      out.write("               RenderTmodelListBySearch('%', offset, maxrecords, false);\n");
      out.write("            }\n");
