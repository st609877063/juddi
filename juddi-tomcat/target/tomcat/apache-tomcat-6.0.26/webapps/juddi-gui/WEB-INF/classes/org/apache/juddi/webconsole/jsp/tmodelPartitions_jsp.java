...
public final class tmodelPartitions_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
...
//                                        <li><a href="publisherBrowse.jsp" title="<%=ResourceLoader.GetResource(session, "navbar.publishers.tooltip")">ResourceLoader.GetResource(session, "navbar.publishers")</a></li>
      ...
      out.write("                <h1>");
      out.print(ResourceLoader.GetResource(session, "pages.tmodelpart.title"));
      out.write("</h1>\n");
      out.write("        </div>\n");
      out.write("\n");
      ...
      out.write("                                ");
      out.print(ResourceLoader.GetResource(session, "pages.tmodelpart.content"));
      out.write("<br><br>\n");
      out.write("                                <div class=\"alert alert-info\">\n");
      out.write("                                        <i class=\"icon-info-sign  icon-large\"></i> ");
      out.print(ResourceLoader.GetResource(session, "pages.tmodelpart.juddinote"));
      out.write("</div>\n");
      out.write("                                <br><Br>\n");
      out.write("                                <table class=\"table\">\n");
      out.write("                                        <tr><td>");
      out.print(ResourceLoader.GetResource(session, "pages.tmodelpart.key"));
      out.write("</td><td><input type=\"text\" value=\"uddi:www.mycompany.com:keygenerator\" id=\"keyGeneratorKey\"  style=\"width:100%\"></td></tr>\n");
      out.write("                                        <tr><td>");
      out.print(ResourceLoader.GetResource(session, "pages.thmodepart.name"));
      out.write("</td><td><input type=\"text\" value=\"My business's key generator\" id=\"keyGeneratorName\" style=\"width:100%\"></td></tr>\n");
      out.write("                                        <tr><td>");
      out.print(ResourceLoader.GetResource(session, "items.lang"));
      out.write("</td><td><input type=\"text\" value=\"");
      out.print(ResourceLoader.GetResource(session, "language"));
      out.write("\" id=\"keyGeneratorLang\" style=\"width:100%\"></td></tr>\n");
      out.write("                                </table>\n");
      out.write("\n");
      out.write("                                <a class=\"btn btn-primary\" title=\"Save\" id=\"savekeygen\" onclick=\"javascript:savekeygen();\">\n");
      out.write("                                        <i class=\"icon-save icon-large\"></i> \n");
      out.write("                                        ");
      out.print(ResourceLoader.GetResource(session, "actions.save"));
      out.write("</a>\n");
      out.write("                        </div><br>\n");
      out.write("                        <script type=\"text/javascript\">\n");
      out.write("                                function savekeygen()\n");
      out.write("                                {\n");
      out.write("                                        //$(\"#results\").html(\"<img src=\\\"img\");\n");
      out.write("                                        $(\"#savekeygen\").addClass(\"disabled\");\n");
      out.write("                                        var keygen = $(\"#keyGeneratorKey\").val();\n");
      out.write("                                        var keyname = $(\"#keyGeneratorName\").val();\n");
      out.write("                                        var keylang = $(\"#keyGeneratorLang\").val();\n");
      out.write("                                        var postbackdata = new Array();\n");
      out.write("\n");
      out.write("                                        postbackdata.push({\n");
      out.write("                                                name: \"action\",\n");
      out.write("                                                value: \"createKeyGen\"\n");
      out.write("                                        });\n");
      out.write("                                        postbackdata.push({\n");
      out.write("                                                name: \"keygen\",\n");
      out.write("                                                value: keygen\n");
      out.write("                                        });\n");
      out.write("                                        postbackdata.push({\n");
      ...
      out.write("                                        });\n");
      out.write("                                        postbackdata.push({\n");
      out.write("                                                name: \"keylang\",\n");
      out.write("                                                value: keylang\n");
      out.write("                                        });\n");
      out.write("                                        postbackdata.push({\n");
      out.write("                                                name: \"nonce\",\n");
      out.write("                                                value: $(\"#nonce\").val()\n");
      ...
      out.write("                                                $(\"#results\").html(msg);\n");
      out.write("                                                $(\"#savekeygen\").removeClass(\"disabled\");\n");
      out.write("                                                $(\"#createtmodelkeygen\").modal();\n");
      out.write("                                        });\n");
      out.write("\n");
      out.write("                                        request.fail(function(jqXHR, textStatus) {\n");
      out.write("                                                window.console && console.log('postback failed ');\n");
      out.write("                                                $(\"#results\").text(textStatus + \" \" + jqXHR.responseText);\n");
      out.write("                                                $(\"#savekeygen\").removeClass(\"disabled\");\n");
      out.write("                                                $(\"#createtmodelkeygen\").modal();\n");
      out.write("\n");
      out.write("                                        });\n");
      ...
      out.write("        </div>\n");
      out.write("\n");
      out.write("        <div class=\"modal hide fade container\" id=\"createtmodelkeygen\">\n");
      out.write("                <div class=\"modal-header\">\n");
      out.write("                        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">&times;</button>\n");
      out.write("                        <h3>");
      out.print(ResourceLoader.GetResource(session, "actions.result"));
