...
public final class serviceEditor_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
...
//                                        <li><a href="publisherBrowse.jsp" title="<%=ResourceLoader.GetResource(session, "navbar.publishers.tooltip")">ResourceLoader.GetResource(session, "navbar.publishers")</a></li>
      ...
      out.write("                <h1>");
      out.print(ResourceLoader.GetResource(session, "pages.serviceeditor.title"));
      out.write("</h1>\n");
      out.write("        </div>\n");
      out.write("\n");
      ...
      out.write("</b>-\n");
      out.write("                                ");
      out.print(ResourceLoader.GetResource(session, "items.service.key.description"));
      out.write("<br>\n");
      ...
      out.write(";\n");
      out.write("                    var currentbindingtemplates = ");
      out.print(bd.getBindingTemplates().getBindingTemplate().size());
      out.write(";\n");
      ...
      out.write("</a></li>\n");
      out.write("\n");
      out.write("                                        <li><a href=\"#bindingtemplates\" >");
      ...
      out.write("                                                $(this).tab('show');\n");
      out.write("                                        });\n");
      out.write("                                        $('#myTab a[href=#bindingtemplates]').click(function(e) {\n");
      out.write("                                                e.preventDefault();\n");
      out.write("                                                $(this).tab('show');\n");
      out.write("                                        });\n");
      ...
      out.write("</b>- \n");
      out.write("                                                ");
      out.print(ResourceLoader.GetResource(session, "items.name.description"));
      out.write("<br>\n");
      out.write("                                                <a href=\"javascript:AddName();\"><i class=\"icon-plus-sign icon-large\"></i></a>");
      out.print(ResourceLoader.GetResource(session, "items.name.add"));
      ...
      out.write("                                        </div>\n");
      out.write("\n");
      out.write("                                        <div class=\"tab-pane\" id=\"bindingtemplates\">\n");
      out.write("                                                <b>");
      out.print(ResourceLoader.GetResource(session, "items.bindingtemplate"));
      out.write("</b>- ");
 ...
 if (!newitem) {
      ...
      out.write("<a href=\"bindingEditor.jsp?svcid=");
      out.print(URLEncoder.encode(bd.getServiceKey(), "UTF8"));
      out.write("\"><i class=\"icon-plus-sign icon-large\"></i></a> ");
      out.print(ResourceLoader.GetResource(session, "items.bindingtemplate.add"));
      out.write("<Br>\n");
      out.write("                                                \n");
      out.write("                                                        ");
      ...
      out.write("</th>\n");
      out.write("                                                                <th>");
      out.print(ResourceLoader.GetResource(session, "items.accesspoint.type"));
      out.write("</th>\n");
      out.write("                                                                <th>");
      ...
      out.write("<br>\n");
      out.write("                                </div><!-- binding template tab pane -->\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write("<script type=\"text/javascript\">\n");
      out.write("                          $.get(\"ajax/validateSignature.jsp?type=service&id=");
      out.print(StringEscapeUtils.escapeJavaScript(bd.getServiceKey()));
      ...
      out.write("<a class=\"btn btn-primary \" href=\"javascript:saveService();\"><i class=\"icon-save icon-large\"></i> ");
      ...
      out.write("<a class=\"btn btn-danger \" href=\"javascript:deleteService();\"><i class=\"icon-trash icon-large\"></i> ");
      out.print(ResourceLoader.GetResource(session, "actions.delete"));
      out.write("</a> |\n");
      out.write("                <a class=\"btn btn-success \" href=\"signer.jsp?id=");
      out.print(URLEncoder.encode(bd.getServiceKey(), "UTF-8"));
      out.write("&type=service\"><i class=\"icon-pencil icon-large\"></i> ");
      out.print(ResourceLoader.GetResource(session, "actions.sign"));
      out.write("</a> |\n");
      out.write("                <a class=\"btn btn-info \" href=\"editSubscription.jsp?svcid=");
      out.print(URLEncoder.encode(bd.getServiceKey(), "UTF-8"));
      out.write("\" title=\"");
      ...
      out.print(URLEncoder.encode(serviceid, "UTF-8"));
      out.write("&type=service\", function(data) {\n");
      ...
      out.print(URLEncoder.encode(bd.getServiceKey(), "UTF-8"));
      out.write("&type=service\" class=\"btn btn-primary\" target=\"_blank\">");
